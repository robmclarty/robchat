...
const serverFolder = 'chat'

const serverConf = require('../config/server');
const host = process.env.SERVER_HOST || 'rebelchat';
const appRoot = `/opt/${ serverFolder }`;
const staticRoot = `/srv/opt/${ serverFolder }`;
const pm2Conf = `/etc/opt/${ serverFolder }/pm2.json`;
